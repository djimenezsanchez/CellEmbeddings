...
class EdgeMinibatchIterator(object):
    ...
    def construct_adj(self):
        ...
        for nodeid in self.G.nodes():
            ...
            adj[self.id2idx[nodeid], :] = neighbors # Reordenamos los vecinos de cada nodo y los repetimos hasta que sean tantos coo max_degree.
        return adj, deg
    ...
    def end_10(self):
        return self.batch_num * self.batch_size >= len(self.train_edges)*0.1
